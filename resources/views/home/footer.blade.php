    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
      ...
      <div class="space-y-4">
        ...
        <div class="flex space-x-4">
          ...
          <a href="Instagram/Instagram" class="text-gray-400 hover:text-white transition">
          ...
          <a href="LinkedIn/LinkedIn" class="text-gray-400 hover:text-white transition">
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-2">
          <li><a href="/dashboard" class="text-gray-400 hover:text-white transition">Latest Products</a></li>
          <li><a href="/dashboard" class="text-gray-400 hover:text-white transition">Different Categories</a></li>
          <li><a href="/dashboard" class="text-gray-400 hover:text-white transition">Cash On Delivery</a></li>
          <li><a href="/dashboard" class="text-gray-400 hover:text-white transition">Online Payment</a></li>
        </ul>
      </div>
